From a daily data file (with nulls) containing id, date, value, write another file with the daily data stored in an array that can be imported into a Postgres DB and containing id, year, month, array (int2).
